...
const EnquiryFormInput = ({ type, placeholder, name }: { type: string; placeholder: string; name: string }) => (
    <div className="px-0 py-1">
        <label htmlFor={name} className="relative block overflow-hidden border-b-2 border-muted-foreground bg-transparent pt-3 dark:border-muted">
            <input
                type={type}
                id={name}
                name={name}
